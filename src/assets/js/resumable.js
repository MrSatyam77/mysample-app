...
(function () {
  ...
  var Resumable = function (opts) {
    ...
    $.defaults = {
      ...
      /** Custome mthod for get all invalid file */
      filesTypeErrorCallback: function (file, errorCount) {
      }
    };
    $.opts = opts || {};
    $.getOpt = function (o) {
    ...
    var appendFilesFromFileList = function (fileList, event) {
      ...
      var errorCount = 0;
      var o = $.getOpt(['maxFiles', 'minFileSize', 'maxFileSize', 'maxFilesErrorCallback', 'minFileSizeErrorCallback', 'maxFileSizeErrorCallback', 'fileType', 'fileTypeErrorCallback', 'filesTypeErrorCallback']);
      ...
      $h.each(fileList, function (file) {
       ...
       /** Custome event added by Hitesh Soni */
       /**For get all invalid file list */
       if (invalidFiles && invalidFiles.length > 0) {
        o.filesTypeErrorCallback(invalidFiles);
        return true;
      }
    };
