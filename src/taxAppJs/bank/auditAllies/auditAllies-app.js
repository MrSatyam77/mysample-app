...
var auditAlliesApp = angular.module('auditAlliesApp', []);

auditAlliesApp.controller('auditAlliesController', ['$location', 'userService', 'dialogService', 'subscriptionService', 
	...
	if(taxYear != '2015') {
		// redirect to home because Audit Allies bank is not use in 2014 & 2016  
		$location.path('/home');
	}
}]);