  ...
  function ($parse,$window) {
    ...
    return {
      ...
      link:function(scope, element, attrs) {
        ...
        angular.element($window).bind('resize',resizeFunction);
        var resizeFunction = function(){
            var _i, _childens = element.children(), _child_len = _childens.length;
              var opts = angular.extend({}, $parse(attrs.uiLayout)(), $parse(attrs.options)());
              var isUsingColumnFlow = opts.flow === 'column';             
        ...
        scope.$on('$destroy',function(){
          angular.element($window).unbind('resize',resizeFunction);
        });
        //Custom Code - End
      },
