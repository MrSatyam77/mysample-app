  ...
  return (function e(t, n, r) {
      ...
      1: [function(require, module, exports) {
          ...
          self.addEventListener("install", function(e) {
              ...
              helpers.debug("install event fired"), helpers.debug("creating cache [" + t + "]"), e.waitUntil(helpers.openCache({
                  cache: {
                      name: t
                  }
              }).then(function(e) {
      ...
      2: [function(require, module, exports) {
          ...
          function openCache(e) {
              var n;
              return e && e.cache && (n = e.cache.name), n = n || globalOptions.cache.name, debug('Opening cache "' + n + '"', e), caches.open(n)
          }
          ...
          function fetchAndCache(e, n) {
              ...
              return fetch(e.clone()).then(function(a) {
                  return "GET" === e.method && c.test(a.status) && openCache(n).then(function(c) {
                      c.put(e, a).then(function() {
                          var a, t, i;
                          n.cache ? (a = n.cache.maxEntries, t = n.cache.maxAgeSeconds, i = n.cache.name) : (a = globalOptions.cache.maxEntries, t = globalOptions.cache.maxAgeSeconds, i = globalOptions.cache.name), (a || t) && i && queueCacheExpiration(e, c, i, a, t)
                      })
                  }), a.clone()
              })
          }
          ...
          function queueCacheExpiration(e, n, c, a, t) {
              ...
              cacheExpirationPromiseChain = cacheExpirationPromiseChain ? cacheExpirationPromiseChain.then(i) : i()
          }

          function cacheExpirationPromiseFactory(e, n, c, a, t) {
              var i = e.url,
                  o = Date.now();
              return debug("Updating LRU order for " + i + ". Max entries is " + a + ", max age is " + t), idbCacheExpiration.getDb(c).then(function(e) {
      ...
      11: [function(require, module, exports) {
          ...
          function networkFirst(e, r, t) {
              ...
              var s = t.successResponses || globalOptions.successResponses,
                  o = t.networkTimeoutSeconds || globalOptions.networkTimeoutSeconds;
